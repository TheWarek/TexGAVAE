...
class vae_next_gen:
    ...
    def __vae_loss(self, vae_input):
        ...
        with tf.variable_scope('vae_loss'):
            ...
            total_loss = tf.reduce_mean(reconstruction_loss + 2.*kl_loss_1+2.*kl_loss_2+2.*kl_loss_3+2.*kl_loss_4)
    ...
    def generate_encoder(self, input):
        with tf.variable_scope('layer_1'):
            ...
            to_dense_1 = tf.layers.conv2d(net_1, filters=32, kernel_size=1, strides=1,
        ...
        with tf.variable_scope('layer_2'):
            ...
            to_dense_2 = tf.layers.conv2d(net_2, filters=32, kernel_size=1, strides=1,
        ...
        with tf.variable_scope('layer_3'):
            ...
            to_dense_3 = tf.layers.conv2d(net_3, filters=64, kernel_size=1, strides=1,
        ...
        with tf.variable_scope('layer_4'):
            ...
            to_dense_4 = tf.layers.conv2d(net_4, filters=64, kernel_size=1, strides=1,
    ...
    def generate_decoder(self, z1, z2, z3, z4, save_variables:bool=False):
        ...
        with tf.variable_scope('lowest_layer'):
            ...
            net_4 = tf.layers.conv2d(out_4, 64, 3, 1, padding='same', reuse=tf.AUTO_REUSE, name='out_conv_4')
        ...
        with tf.variable_scope('second_lowest_layer'):
            ...
            out_3 = tf.layers.conv2d(out_3, 64, 3, 1, padding='same',reuse=tf.AUTO_REUSE, name='out_conv_3')
        ...
        with tf.variable_scope('second_highest_layer'):
            ...
            out_2 = tf.layers.conv2d(out_2, 64, 3, 1, padding='same',reuse=tf.AUTO_REUSE, name='out_conv_2')
            ...
            net_2 = tf.layers.conv2d(net_2, 32, 3, 1, padding='same', reuse=tf.AUTO_REUSE, name='conv_2')
            net_2 = tf.nn.leaky_relu(net_2, name='relu_2')
            net_2 = tf.layers.batch_normalization(net_2, name='batchnorm_2')
        ...
        with tf.variable_scope('top_layer'):
            ...
            out_1 = tf.layers.conv2d(out_1, 32, 3, 1, padding='same',reuse=tf.AUTO_REUSE, name='out_conv_1')
            ...
            net_1 = tf.layers.conv2d(net_1, 32, 3, 1, padding='same', reuse=tf.AUTO_REUSE, name='conv_1')
    ...
    def train(self, iterations, save_interval, log_interval, model_file):
        ...
        with self.sess:
            ...
            for iteration in range(0,iterations+1):
                ...
                _, vae_loss, merged = self.sess.run([self.vae_train_step_1, self.vae_loss, summary_vae])
...
# i = 0
# result = self.sess.run(self.dec_out, feed_dict={self.z_1_input:zz1[i].reshape(1,20),self.z_2_input:zz2[0].reshape(1,20),self.z_3_input:z3.reshape(1,20),self.z_4_input:zz4[i].reshape(1,20),})
# plt.imshow(result.reshape(64,64),cmap='gray')
# plt.show()
